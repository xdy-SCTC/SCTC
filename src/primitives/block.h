...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // sctc
        hashUTXORoot.SetNull(); // sctc
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //sctc
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //sctc
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //sctc
    {
