...
void RPCNestedTests::rpcNestedTests()
{
    ...
    globalState = std::unique_ptr<SctcState>(new SctcState(dev::u256(0), SctcState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
    dev::eth::ChainParams cp((dev::eth::genesisInfo(dev::eth::Network::sctcTestNetwork)));
