...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("SCTC");
    case mBTC: return QString("mSCTC");
    case uBTC: return QString::fromUtf8("μSCTC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Sctcs");
    case mBTC: return QString("Milli-Sctcs (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Sctcs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
