...
/////////////////////////////////////////// sctc
#include <sctc/sctcstate.h>
#include <sctc/sctcDGP.h>
#include <libethereum/ChainParams.h>
#include <libethashseal/Ethash.h>
#include <libethashseal/GenesisInfo.h>
#include <script/standard.h>
#include <sctc/storageresults.h>


extern std::unique_ptr<SctcState> globalState;
...
using ExtractSctcTX = std::pair<std::vector<SctcTransaction>, std::vector<EthTransactionParams>>;
///////////////////////////////////////////
...
static const size_t MAX_CONTRACT_VOUTS = 1000; // sctc
...
void EnforceContractVoutLimit(ByteCodeExecResult& bcer, ByteCodeExecResult& bcerOut, const dev::h256& oldHashSctcRoot,
    const dev::h256& oldHashStateRoot, const std::vector<SctcTransaction>& transactions);
...
class SctcTxConverter{

public:

    SctcTxConverter(CTransaction tx, CCoinsViewCache* v = NULL, const std::vector<CTransactionRef>* blockTxs = NULL) : txBit(tx), view(v), blockTransactions(blockTxs){}

    bool extractionSctcTransactions(ExtractSctcTX& sctcTx);
...
private:
    ...
    SctcTransaction createEthTX(const EthTransactionParams& etp, const uint32_t nOut);
...
public:
    ...
    ByteCodeExec(const CBlock& _block, std::vector<SctcTransaction> _txs, const uint64_t _blockGasLimit) : txs(_txs), block(_block), blockGasLimit(_blockGasLimit) {}
